    ...
    <div class="container">
        <div class="d-flex">
            <a class="header-brand" href="../index.php">
                <span class="brand-text">BOORAQ</span>
            </a>
...
<div class="menu-nav collapse d-lg-flex " id="headerMenuCollapse">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-3 ml-auto">
                <form class="input-icon my-3 my-lg-0">
                    <input type="search" class="form-control header-search" placeholder="Cari Cepat"
                           tabindex="1">
