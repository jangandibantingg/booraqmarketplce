      ...
      if(!empty($_SESSION["shopping_cart"]))
      {
           ...
           foreach($_SESSION["shopping_cart"] as $keys => $values)
           {
                $order_table .= '
                     <tr>
                          ...
                          <td align="right">IDR '.$values["product_price"].'</td>
                          <td align="right">IDR '.number_format($values["product_quantity"] * $values["product_price"], 2).'</td>
           ...
           $order_table .= '
                <tr>
                     ...
                     <td align="right">IDR '.number_format($total, 2).'</td>
                     <td></td>
                </tr>
                <tr>
