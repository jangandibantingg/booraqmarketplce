     ...
     if(!empty($_SESSION["shopping_cart"]))
     {
          ...
          foreach($_SESSION["shopping_cart"] as $keys => $values)
          {
               $order_table .= '
                    <tr>
                         ...
                         <td align="right"><button name="delete" class="btn btn-danger btn-xs delete" id="'.$values["product_id"].'"><i class="fa fa-trash"></i></button></td>
                    </tr>
               ';
          ...
          $order_table .= '
               ...
               <td colspan="5"  align="center">
                    <form method="post" action="control/simpan-belanja.php?act='.$values['product_page'].'">
