...
if($total < 0){
 echo "<div class='alert alert-danger alert-dismissible text-center'><i class='ti-face-sad'> Tidak dapat diproses, karena nilai cash kurang dari subtotal belanja </div>";
}else {
  ...
  echo "<p><div class='alert alert-rounded text-center'>
            <a href='parent.location=printscheme://http://backoffice.codercoffee.id/control/print-penjualan.php'>Click me</a>
          <button class='btn btn-outline-primary' id='cetakstruk'><i id='cetakstruk' class='fa fa-print'></i> Cetak Struk</button>
          <hr>
...
<script>
  ...
  function loadOtherPage1() {
      $("<iframe id='cetakstruk'>")
          .hide()
          .attr("src", "control/print-penjualan.php")
          .appendTo("body");
      }

    </script>
<input type="button" onclick="parent=location='printscheme://http://backoffice.codercoffee.id/control/print-penjualan.php'" name="" value="cetak">
